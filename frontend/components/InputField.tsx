    ...
    <KeyboardAvoidingView behavior={Platform.OS === "ios" ? 'padding': 'height'}>
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <View className='my-2 w-full '>
                ...
                <View className={`flex flex-row justify-start items-center relative bg-neutral-100 rouded-full border-neutral-100 focus:border-primary-500 ${containerStyle}`}>
